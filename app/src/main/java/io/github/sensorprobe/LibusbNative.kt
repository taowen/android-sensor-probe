...
object LibusbNative {
    ...
    external fun startTrace(handle:Long,path:String):Boolean
    ...
    external fun startEndpointReader(handle:Long,interfaceId:Int,endpoint:Int,transferType:Int,packetSize:Int):Int
